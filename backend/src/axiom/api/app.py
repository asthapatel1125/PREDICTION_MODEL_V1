...
def create_app(settings:PlatformSettings|None=None)->FastAPI:
    ...
    async def wall_dealerflow(symbol:str="QQQ",start:datetime|None=None,end:datetime|None=None):
        ...
        fields=("timestamp","spot","dex","vol_hack","dealer_flow","pos_inventory","neg_inventory","tw_gex","gex_density","gex_dollar_density","spoof_score","edge","liquidity","vix","regime",
            "gex_imbalance_pct","dex_imbalance_pct","vol_imbalance_pct","pressure_composite_raw","speed_pct","zomma_pct","dex_pct","gex_pct","dealer_flow_pct","dealer_delta_velocity","zero_gamma_pct","effective_gex_pct",
