...
class AppErrorBoundary extends React.Component {
  ...
  render() {
    ...
    return <main style={{minHeight:"100vh",background:"#050a10",color:"#dbe7f3",display:"grid",placeItems:"center",padding:"32px",fontFamily:"var(--font-mono)"}}>
      <section style={{maxWidth:"720px",width:"100%",border:"1px solid #31536d",borderRadius:"12px",padding:"28px",background:"#0a141e",boxShadow:"0 12px 40px #0008"}}>
        ...
        <h1 style={{margin:"8px 0 12px",fontFamily:"var(--font-sans)"}}>The dashboard hit a display error</h1>
