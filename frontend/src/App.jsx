...
function WallIntelligenceRefined({symbol}){
  const [spectrum,setSpectrum]=useState([]),[breaks,setBreaks]=useState([]),[history,setHistory]=useState([]),[currentState,setCurrentState]=useState({}),[frame,setFrame]=useState("15M"),[category,setCategory]=useState("Walls & Levels"),[variable,setVariable]=useState("Call Wall"),[traces,setTraces]=useState(["Call Wall"]),[dealerTraces,setDealerTraces]=useState(["DealerFlow"]),[hover,setHover]=useState(null);const latestSpectrum=useRef([]);
  ...
  const categories={"Zone Intelligence":["QQQ Price","TW GEX","GEX Density","Spoof Score","Edge","Liquidity","VIX"],"Walls & Levels":["Call Wall","Put Wall","Zero Gamma","Support","Resistance","Support / Resistance Spread"],"Flow & Inventory":["DealerFlow","DEX","VolHack","Pos Inventory","Neg Inventory"],"Risk & Quality":["Spoof Score","Edge","Liquidity","VIX","GEX Density"]};
