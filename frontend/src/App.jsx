...
function WallIntelligenceWorkspace({symbol}){
  const nextId=useRef(2),[spectrum,setSpectrum]=useState([]),[breaks,setBreaks]=useState([]),[summaries,setSummaries]=useState([]),[tab,setTab]=useState("LOG"),[charts,setCharts]=useState([{id:1,selected:["Call Wall","Put Wall","Resistance"]}]);
