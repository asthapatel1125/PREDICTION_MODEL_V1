...
function GammaDynamicsChart({history=[],state,symbol,deltaMode=false}){
  ...
  const dims={width:1200,height:expanded?(deltaMode?980:760):(deltaMode?820:500),left:deltaMode?190:138,right:30,top:20,bottom:58},plotWidth=dims.width-dims.left-dims.right,plotHeight=dims.height-dims.top-dims.bottom,laneHeight=plotHeight/series.length;
