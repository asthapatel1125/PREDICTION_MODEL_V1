...
function CustomGreekChart({chart,index,history,state,symbol,onChange,onRemove,canRemove}){
  ...
  const dims={width:expanded?1400:720,height:expanded?700:normalHeight,left:expanded?150:112,right:expanded?34:18,top:12,bottom:expanded?58:46},plotWidth=dims.width-dims.left-dims.right,plotHeight=dims.height-dims.top-dims.bottom,laneHeight=plotHeight/Math.max(series.length,1);
