...
export default function Home() {
  ...
  const [apiConnected,setApiConnected]=useState(false),[streamConnected,setStreamConnected]=useState(false), [toast,setToast]=useState(""), [replay,setReplay]=useState(null);
